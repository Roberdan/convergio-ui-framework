...
export default function MaranelloPreview() {
  ...
  return (
    <div className="min-h-screen bg-[var(--mn-surface-primary)] text-[var(--mn-text-primary)] p-8 space-y-12">
      <header className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">
          🏎️ Maranello Design System — Preview
        </h1>
        <p className="text-[var(--mn-text-secondary)]">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold border-b border-[var(--mn-border-default)] pb-2">
          MnBadge
        </h2>
      ...
      <section className="space-y-3">
        ...
        <div className="max-w-md space-y-4">
          <MnFormField>
            ...
            <input
              type="email"
              className="w-full rounded-md border border-[var(--mn-border-default)] bg-[var(--mn-surface-secondary)] px-3 py-2 text-sm"
          ...
          <MnFormField error="Password must be at least 8 characters.">
            ...
            <input
              type="password"
              className="w-full rounded-md border border-red-500 bg-[var(--mn-surface-secondary)] px-3 py-2 text-sm"
              placeholder="••••••••"
            />
          </MnFormField>
        </div>
      ...
      <section className="space-y-3">
        ...
        <MnTabs defaultValue="overview">
          ...
          <MnTabPanel value="overview">
            <div className="p-4 rounded-b-lg border border-t-0 border-[var(--mn-border-default)]">
      ...
      <section className="space-y-3">
        ...
        <button
          ...
          className="px-4 py-2 rounded-md bg-[var(--mn-accent-primary)] text-white font-medium hover:opacity-90 transition-opacity"
        >
          Open Modal
        </button>
        <MnModal open={modalOpen} onOpenChange={setModalOpen}>
          <div className="space-y-4">
            ...
            <button
              ...
              className="px-4 py-2 rounded-md bg-[var(--mn-accent-primary)] text-white font-medium"
            >
              Close
            </button>
          </div>
      ...
      <section className="space-y-3">
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-md bg-yellow-600 text-white text-sm"
          >
            Warning
          </button>
          <button
